...
<link rel="stylesheet" href="<?= CSSPATH ?>/announcements.css">
...
<div class="body">
    ...
    <main class="main-content" id="main-content" tabindex="-1">
        ...
        <div class="announcements-header">
            ...
            <p class="announcements-subtitle">Latest updates from BSU research offices</p>
        </div>

        <div class="fb-pages-grid">

            <!-- BSU Research Services -->
            <section class="fb-page-section">
                ...
                <div class="fb-embed-wrap">
                    <div class="fb-page"
                        data-href="https://www.facebook.com/BSU.Research.Services/"
                        data-tabs="timeline"
                        data-width=""
                        data-height="620"
